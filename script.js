...
//	whatever number of results
	var queryEarth = "http://api.giphy.com/v1/gifs/search?q=earth" +x+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=1";
...
$('#africa').on('click', function() {
	...
	var queryAfrica = "http://api.giphy.com/v1/gifs/search?q=africa" +af+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=5";
...
$('#antarctica').on('click', function() {
	...
	var queryAntarctica = "http://api.giphy.com/v1/gifs/search?q=antarctica" +an+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=5";
...
$('#asia').on('click', function() {
	...
	var queryAsia = "http://api.giphy.com/v1/gifs/search?q=asia" +asi+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=5";
...
$('#australia').on('click', function() {
	...
	var queryAustralia = "http://api.giphy.com/v1/gifs/search?q=australia" +au+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=5";
...
$('#europe').on('click', function() {
	...
	var queryEurope = "http://api.giphy.com/v1/gifs/search?q=europe" +eu+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=5";
...
$('#northAmerica').on('click', function() {
	...
	var queryNorthAmerica = "http://api.giphy.com/v1/gifs/search?q=northAmerica" +na+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=5";
...
$('#southAmerica').on('click', function() {
	...
	var querySouthAmerica = "http://api.giphy.com/v1/gifs/search?q=southAmerica" +sa+ "&api_key=b8166dc140c94f118151f1da044858ea&limit=5";
